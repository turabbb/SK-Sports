...
const Categories = () => {
  const categories = [
    { 
      id: 1, 
      name: 'Cricket', 
      path: '/sports?categories=Hard Ball Bat,Tape Ball Bat,Pads,Thigh Pads,Batting Gloves,Keeping Gloves,Helmet,Guard,Tape Ball,Hard Ball,Kit Bags,Boots', 
      image: cat1 
    },
    { 
      id: 2, 
      name: 'Football', 
      path: '/sports?categories=Football,Football Jerseys', 
      image: cat2 
    },
    { 
      id: 3, 
