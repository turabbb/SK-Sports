...
const filters = {
    categories: [
        ...
        'Cricket Spikes', 'Football Boots', 'Football', 'SportsWear Shirts'
    ],
    ...
    return (
        <>
            <section className='section__container bg-primary-light'>
                <h2 className='section__header capitalize'>Sportswear Collection</h2>
                <p className='section__subheader'>Browse through our premium sports equipment and athletic gear.</p>
            </section>
