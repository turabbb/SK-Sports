...
const Checkout = () => {
  ...
  return (
    <>
          ...
          <>
            ...
            >
              <div className="bg-white rounded-xl p-8 text-center max-w-md w-full shadow-xl">
                ...
                <button
                  onClick={closeModal}
                  className="mt-6 px-5 py-2 bg-green-600 text-white rounded-lg shadow hover:bg-green-700 transition"
                >
                  Continue Shopping
                </button>
              </div>
      ...
      {/* Main checkout form and summary */}
                ...
                <div key={idx} className="flex justify-between items-center border-b pb-4 last:border-b-0">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mt-1">Quantity: <span className="font-medium text-gray-700">{item.quantity}</span></p>
                    </div>
                  </div>
