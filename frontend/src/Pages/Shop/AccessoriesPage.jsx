...
const filters = {
    categories: [
        'All', 'Indoor Games', 'Gym Accessories'
    ],
...
// Default categories for Accessories page
const defaultCategories = ['Indoor Games', 'Gym Accessories'];
    ...
    return (
        <>
            <section className='section__container bg-primary-light px-4 sm:px-6 lg:px-8 py-6 sm:py-8'>
                <h2 className='section__header capitalize text-2xl sm:text-3xl lg:text-4xl'>Sports Accessories</h2>
                <p className='section__subheader text-sm sm:text-base lg:text-lg'>Browse through our essential sports accessories and fitness gear.</p>
            </section>
