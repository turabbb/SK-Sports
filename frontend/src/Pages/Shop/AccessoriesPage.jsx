    ...
    return (
        <>
            <section className='section__container bg-primary-light'>
                <h2 className='section__header capitalize'>Sports Accessories</h2>
                <p className='section__subheader'>Browse through our essential sports accessories and fitness gear.</p>
            </section>
